...
<script type="text/javascript" src=<?php echo $sym['assets']->getUrl('/bundles/ibrowssimplecms/js/ajaxfilemanager/jscripts/jquery.js') ?>></script>
<script type="text/javascript" src=<?php echo $sym['assets']->getUrl('/bundles/ibrowssimplecms/js/ajaxfilemanager/jscripts/form.js') ?>></script>
<script type="text/javascript" src=<?php echo $sym['assets']->getUrl('/bundles/ibrowssimplecms/js/ajaxfilemanager/jscripts/select.js') ?>></script>
<script type="text/javascript" src=<?php echo $sym['assets']->getUrl('/bundles/ibrowssimplecms/js/ajaxfilemanager/jscripts/thickbox.js') ?>></script>
<script type="text/javascript" src=<?php echo $sym['assets']->getUrl('/bundles/ibrowssimplecms/js/ajaxfilemanager/jscripts/calendar.js') ?>></script>
<script type="text/javascript" src=<?php echo $sym['assets']->getUrl('/bundles/ibrowssimplecms/js/ajaxfilemanager/jscripts/contextmenu.js') ?>></script>
<script type="text/javascript" src=<?php echo $sym['assets']->getUrl('/bundles/ibrowssimplecms/js/ajaxfilemanager/jscripts/media.js') ?>></script>
<script type="text/javascript" src=<?php echo $sym['assets']->getUrl('/bundles/ibrowssimplecms/js/ajaxfilemanager/jscripts/ajaxfileupload.js') ?>></script>
<script type="text/javascript" src=<?php echo $sym['assets']->getUrl('/bundles/ibrowssimplecms/js/ajaxfilemanager/jscripts/ajaxfilemanager.js') ?>></script>
...
<script type="text/javascript" src="<?php echo $sym['assets']->getUrl('/bundles/ibrowssimplecms/js/ajaxfilemanager/jscripts/for_tinymce.js') ?>"></script>
<link rel="stylesheet" type="text/css" href="<?php echo $sym['assets']->getUrl('/bundles/ibrowssimplecms/js/ajaxfilemanager/theme/default/css/ajaxfilemanager.css') ?>"/>
<link rel="stylesheet" type="text/css" href="<?php echo $sym['assets']->getUrl('/bundles/ibrowssimplecms/js/ajaxfilemanager/theme/default/css/tinymce.css') ?>"/>
<link rel="stylesheet" type="text/css" href="<?php echo $sym['assets']->getUrl('/bundles/ibrowssimplecms/js/ajaxfilemanager/theme/default/css/jquery-calendar.css') ?>"/>
<link rel="stylesheet" href="<?php echo $sym['assets']->getUrl('/bundles/ibrowssimplecms/js/ajaxfilemanager/theme/default/css/thickbox.css') ?>" type="text/css" media="screen" />
