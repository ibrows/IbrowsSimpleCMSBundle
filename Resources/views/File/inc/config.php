<?php
	...
	addNoCacheHeaders();
	//URL Declartions
	if(!defined('CONFIG_URL_IMAGE_PREVIEW')){
    	define('CONFIG_URL_IMAGE_PREVIEW', 'ajax_image_preview.html.php');
    	define('CONFIG_URL_CREATE_FOLDER', 'ajax_create_folder.html.php');
    	define('CONFIG_URL_DELETE', 'ajax_delete_file.html.php');
    	define('CONFIG_URL_HOME', 'ajaxfilemanager.html.php');
    	define("CONFIG_URL_UPLOAD", 'ajax_file_upload.html.php');
    	define('CONFIG_URL_PREVIEW', 'ajax_preview.html.php');
    	define('CONFIG_URL_SAVE_NAME', 'ajax_save_name.html.php');
    	define('CONFIG_URL_IMAGE_EDITOR', 'ajax_image_editor.html.php');
    	define('CONFIG_URL_IMAGE_SAVE', 'ajax_image_save.html.php');
    	define('CONFIG_URL_IMAGE_RESET', 'ajax_editor_reset.html.php');
    	define('CONFIG_URL_IMAGE_UNDO', 'ajax_image_undo.html.php');
    	define('CONFIG_URL_CUT', 'ajax_file_cut.html.php');
    	define('CONFIG_URL_COPY', 'ajax_file_copy.html.php');
    	define('CONFIG_URL_LOAD_FOLDERS', '_ajax_load_folders.html.php');
    	
    	define('CONFIG_URL_DOWNLOAD', 'ajax_download.html.php');
    	define('CONFIG_URL_TEXT_EDITOR', 'ajax_text_editor.html.php');
    	define('CONFIG_URL_GET_FOLDER_LIST', 'ajax_get_folder_listing.html.php');
    	define('CONFIG_URL_SAVE_TEXT', 'ajax_save_text.html.php');
    	define('CONFIG_URL_LIST_LISTING', 'ajax_get_file_listing.html.php');
    	define('CONFIG_URL_IMG_THUMBNAIL', 'ajax_image_thumbnail.html.php');
    	define('CONFIG_URL_FILEnIMAGE_MANAGER', 'ajaxfilemanager.html.php');
    	define('CONFIG_URL_FILE_PASTE', 'ajax_file_paste.html.php');
	}
