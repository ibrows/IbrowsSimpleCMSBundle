...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	if(!defined('CONFIG_SYS_DEFAULT_PATH'))define('CONFIG_SYS_DEFAULT_PATH', $CONFIG_SYS_DEFAULT_PATH); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', CONFIG_SYS_DEFAULT_PATH);	//accept relative path only
	...
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,bmp,tif,tiff,zip,sit,rar,gz,tar,htm,html,mov,mpg,avi,asf,mpeg,wmv,aif,aiff,wav,mp3,swf,ppt,rtf,doc,pdf,xls,xlsx,txt,xml,xsl,dtd');//
	define("CONFIG_VIEWABLE_VALID_EXTS", CONFIG_UPLOAD_VALID_EXTS);//'gif,bmp,txt,jpg,png,tif,html,htm,js,css,xml,xsl,dtd,mp3,wav,wmv,wma,rm,rmvb,mov,swf');
	//define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,txt'); // 
